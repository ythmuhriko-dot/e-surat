...
<head>
    <meta charset="UTF-8">
    <title>Cetak Surat Keterangan Sakit - <?php echo htmlspecialchars($data['nama_pasien'] ?? '-'); ?></title>
    <style>
...
<body>
    ...
    <div class="isi-surat">
        ...
        <p>Berdasarkan hasil pemeriksaan menunjukkan bahwa yang bersangkutan dalam kondisi sakit dan membutuhkan istirahat selama <strong><?php echo htmlspecialchars($data['alasan_sakit'] ?? '-'); ?></strong>, pada tanggal <strong><?php echo htmlspecialchars($tanggal_mulai); ?></strong> sampai dengan tanggal <strong><?php echo htmlspecialchars($tanggal_selesai); ?></strong>.</p>
